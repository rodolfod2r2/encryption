package org.framework.rodolfo.freire.git.encryption.core.component;
...
import org.framework.rodolfo.freire.git.encryption.core.factory.EncryptFactory;
import org.framework.rodolfo.freire.git.encryption.core.factory.EnumFactory;
import org.framework.rodolfo.freire.git.encryption.core.util.CustomObject;
import org.framework.rodolfo.freire.git.encryption.core.util.CustomReflection;
    ...
    public void decryptObject(Object object, EnumFactory enumFactory) {
        ...
        for (Field field : object.getClass().getDeclaredFields()) {
            if (field.isAnnotationPresent(EncryptField.class)) {
                ...
                if (encryptField.decryptField().equals(EnumEncrypt.TRUE) && CustomObject.notBlank(valueField)) {
    ...
    public void encryptObject(Object object, EnumFactory enumFactory) {
        ...
        for (Field field : object.getClass().getDeclaredFields()) {
            if (field.isAnnotationPresent(EncryptField.class)) {
                ...
                String valueField = getFieldValue(object, field);
                if (encryptField.encryptField().equals(EnumEncrypt.TRUE) && CustomObject.notBlank(valueField)) {
